...
class Calculator {
    ...
    appendNumber(number) {
        if (number === "." && this.currentOper.includes(".") || number === "." && this.currentOper === "" || number === "0" && this.currentOper === "0" || this.currentOper.length > 11) return;
        this.currentOper = this.currentOper.toString() + number.toString();
    }
    chooseOperation(op) {
        if (this.currentOper === "") return;
        if (this.currentOper !== "") this.compute();
        if (this.currentOperand.innerText !== "") this.currentOper = this.currentOperand.innerText;
    ...
    compute() {
        ...
        if (lengthOut < 14) this.currentOperand.innerText = computation;
        else this.currentOperand.innerText = "TooLong";
    }
    updateDisplay() {
        this.previousOperand.innerText = this.currentOper;
        if (this.operation) this.previousOperand.innerText = `${this.previousOper}
...
},{}]},["iIhvB","3cYfC"], "3cYfC", "parcelRequire79d6")
